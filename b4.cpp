...
bool CheckSize (int SizeA, int SizeB, int SizeC){
...
void loopCheck(vector<vector<bool>>& Check, int SizeA, int SizeB, string A, string B, string C){
...
int main(){
    ...
    loopCheck(Check, SizeA, SizeB, A, B, C);
